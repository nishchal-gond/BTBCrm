...
const OWNERS = [
	{ name: "Ada Okafor", email: "ada@academy.example" },
	{ name: "Marcus Lindqvist", email: "marcus@academy.example" },
	{ name: "Priya Raman", email: "priya@academy.example" },
] as const;
